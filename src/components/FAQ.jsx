                ...
                <div className="container flex flex-col justify-items-center px-4 py-8 mx-auto md:p-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <details className="w-full border rounded-lg">
                            ...
                            <p className="px-4 py-6 pt-4 ml-4 -mt-4 text-lg bg-sky-500 rounded-md dark:text-gray-400">When you learn programming, it is not only about the knowledge you acquire, but also (and specially) about the useful transferable skills you get. And the fact is that, in addition to becoming more precise and methodic, when you learn programming, you significantly improve your problem solving and abstraction skills. </p>
                        </details>
                        <details className="w-full border rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none text-2xl focus-visible:ring-violet-400">What is Framework?</summary>
                            <p className="px-4 py-6 pt-4 ml-4 -mt-4 text-lg bg-sky-500 rounded-md dark:text-gray-400">In computer programming, a software framework is an abstraction in which software, providing generic functionality, can be selectively changed by additional user-written code, thus providing application-specific software. </p>
                        </details>
                        <details className="w-full border rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none text-2xl focus-visible:ring-violet-400">What is React?</summary>
                            <p className="px-4 py-6 pt-4 ml-4 -mt-4 text-lg bg-sky-500 rounded-md dark:text-gray-400">React is a free and open-source front-end JavaScript library for building user interfaces based on UI components. It is maintained by Meta and a community of individual developers and companies.  </p>
                        </details>
                        <details className="w-full border rounded-lg">
                            ...
                            <p className="px-4 py-6 pt-4 ml-4 -mt-4 text-lg bg-sky-500 rounded-md dark:text-gray-400">It is a used as backend service where javascript works on the server-side of the application. This way javascript is used on both frontend and backend. Node. js runs on chrome v8 engine which converts javascript code into machine code, it is highly scalable, lightweight, fast, and data-intensive </p>
                        </details>
                    </div>
                </div>
            </section>
