...
const Review = () => {
    return (
        <div className='my-16'>
            <h2 className="text-4xl my-14 font-bold text-center underline underline-offset-8 text-black">Review's</h2>
            <div className=''>
                <div className=" flex flex-col shadow-lg duration-300 hover:shadow-slate-500  w-5/6 lg:w-2/4 p-6 mx-auto divide-y rounded-md dark:text-gray-100">
                    <div className="flex justify-between p-4">
                        ...
                        <div className="flex items-center space-x-2 text-yellow-900 dark:text-yellow-500">
