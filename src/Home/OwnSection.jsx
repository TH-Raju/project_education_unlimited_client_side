import React from 'react'; import img from '../image/pp.jpg';
        ...
        <div className='mt-10'>
            <section className="py-8 dark:bg-gray-800 dark:text-gray-100">
                <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-24 h-24 dark:text-violet-400">
                    ...
                    <div className="flex justify-center space-x-3">
                        ...
                        <div>
                            ...
                            <a className="flex items-center py-2 space-x-1 text-sm dark:text-violet-400" href="https://www.facebook.com/rjraju.r8/" target='__blank'>
